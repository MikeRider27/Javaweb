...
public class MarcaCTR extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        MarcaDTO marcaDTO;
        MarcaDAO marcaDAO;
        marcaDTO = gson.fromJson(cadenaJSON, MarcaDTO.class);
        marcaDAO = new MarcaDAO();

        switch (marcaDTO.getBandera()) {
            case 1:
                if (marcaDAO.agregar(marcaDTO)) {
            ...
            case 4:
//                PrintWriter out = response.getWriter();
                String json = gson.toJson(marcaDAO.seleccionarSegunId(marcaDTO));
                if (json != null) {
            ...
            case 5:
                //Cargar Tabla
                response.setContentType("application/json, charset=UTF-8");
                String cadenaDepartamento = gson.toJson(marcaDAO.seleccionarTodos());
