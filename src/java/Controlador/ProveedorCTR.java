...
public class ProveedorCTR extends HttpServlet {
...
//                PrintWriter out = response.getWriter();
            ...
            case 5:
                //Cargar Tabla
                response.setContentType("application/json, charset=UTF-8");
                String cadenaProveedorTodos = gson.toJson(proveedorDAO.seleccionarTodos());
                if (cadenaProveedorTodos != null) {
                    //enviar al js la cadena 
                    System.out.println("Cadena " + cadenaProveedorTodos);
                    out.println(cadenaProveedorTodos);
                } else {
