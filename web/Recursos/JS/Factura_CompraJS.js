...
//            alert(xhr.responseText);
            ...
            for (i = 0; i < json.length; i++) {
                ...
                filas += "<td class=\"w3-hide\">" + json[i].exento + "</td>";
                filas += "<td class=\"w3-hide\">" + json[i].iva5 + "</td>";
                filas += "<td class=\"w3-hide\">" + json[i].iva10 + "</td>";
                filas += "<td> <img onclick=\"recuperarMercaderiaFacturaCompra(" + json[i].cod_mercaderia + ",\n\
'" + json[i].articulo + "', '" + json[i].precio_unitario + "', " + json[i].exento + ",\n\
" + json[i].iva5 + ", " + json[i].iva10 + ", 'codigo_mercaderia' , 'mercaderia','precio_unitario_mercaderia', \n\
'excento', 'iva5', 'iva10') \n\
\" src=\"../Recursos/Img/select.png\" alt=\"Sel\"/></td>";
                filas += "</tr>";
            }
...
function recuperarMercaderiaFacturaCompra(cod_mercaderia, articulo, precio_unitario, i_exento, i_iva5, i_iva10,
        codigo_mercaderia, mercaderia, precio_unitario_mercaderia, cam_excento, cam_iva5, cam_iva10) {
    ...
    document.getElementById(cam_excento).value = i_exento;
    document.getElementById(cam_iva5).value = i_iva5;
    document.getElementById(cam_iva10).value = i_iva10;
    console.log("Tipos de impuestos: " + i_exento + ", " + i_iva5 + ", " + i_iva10);
    document.getElementById('cantidad_mercaderia').focus();
...
////    document.getElementById("detalleTablaMercaderia").value = 0;
    $('#detalleTablaMercaderia_Factura_Compra').empty();

    document.getElementById('form_factura_compra').reset();
}
